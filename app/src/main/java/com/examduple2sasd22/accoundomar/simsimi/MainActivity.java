package com.examduple2sasd22.accoundomar.simsimi;
...
import com.examduple2sasd22.accoundomar.simsimi.Adapter.CustomAdapter;
import com.examduple2sasd22.accoundomar.simsimi.Helper.HttpDataHandler;
import com.examduple2sasd22.accoundomar.simsimi.Models.ChatModel;
import com.examduple2sasd22.accoundomar.simsimi.Models.SimsimiModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_send_message.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                list_chat.add(model);
                new SimsimiAPL().execute(list_chat);
                //remove user message
                editText.setText("");
            }
        });
    ...
    private class SimsimiAPL  extends AsyncTask<List<ChatModel>,Void,String>{
